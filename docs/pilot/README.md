# ACP Pilot Operations Kit

This directory turns the ACP pilot operations spec into concrete materials for running the fellowship pilot.

## Contents

- `runbooks/operator-cycle-runbook.md`: end-to-end operator procedure for a single cycle
...
- `templates/cycle-setup-template.csv`: setup sheet for prompt, condition, and roster tracking

## Operating rule

Operators should not invent pilot procedure live. Every cycle should be run against these materials, with deviations recorded explicitly in the anomaly and recovery logs.
